<div>
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <i  class="badge bg-label-info ms-1">All Activity Logs are for the Previous Day</i>
    </div> <br/>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          ...
          <li class="d-flex mb-6">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded bg-label-info"><i class="ti ti-car ti-26px"></i></span>
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
