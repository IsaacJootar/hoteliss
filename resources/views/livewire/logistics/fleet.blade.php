        ...
        <div class="card overflow-hidden">
            ...
            <div class="d-flex app-logistics-fleet-wrapper">
                ...
                <div class="flex-shrink-0 position-fixed m-6 d-md-none w-auto z-1">
                    <button class="btn btn-white btn-white-dark-variant z-2 p-2" data-bs-toggle="sidebar"
                        ...
                        <div class="accordion py-2 px-1" id="fleet" data-bs-toggle="sidebar" data-overlay
                            ...
                            <div class="accordion-item border-0 active mb-0 shadow-none" id="fl-1">
                                <div class="accordion-header" id="fleetOne">
                                    <div role="button" class="accordion-button shadow-none align-items-center"
                                        data-bs-toggle="collapse" data-bs-target="#fleet1" aria-expanded="true"
                                    ...
                                    <div class="accordion-body pt-4 pb-0">
                                        ...
                                        <ul class="timeline ps-4 mt-6">
                                            ...
                                            <li class="timeline-item ps-6 pb-3 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    <div class="timeline-header">
                                                        <small class="text-success text-uppercase">out for
                                                            delivery</small>
                                                    </div>
                                                    <h6 class="my-50">Veronica Herman</h6>
                                    ...
                                    <div role="button" class="accordion-button collapsed shadow-none align-items-center"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-wrapper">
                                                <div class="avatar me-4">
                                                    <span class="avatar-initial rounded-circle bg-label-secondary"><i
                                                            class="ti ti-truck ti-sm"></i></span>
                                                </div>
                                            </div>
                                            <span class="d-flex flex-column gap-1">
                            ...
                            <div class="accordion-item border-0 mb-4 shadow-none" id="fl-4">
                                <div class="accordion-header" id="fleetFour">
                                    <div role="button" class="accordion-button collapsed shadow-none align-items-center"
                                        data-bs-toggle="collapse" data-bs-target="#fleet4" aria-expanded="true"
