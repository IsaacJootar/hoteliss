        ...
        <div class="modal-body">
          ...
          <div class="mb-6">
            <label for="note" class="fw-medium text-heading mb-1">Enter Message:</label>
              <textarea wire:model='message' class="form-control" rows="2" id="note"></textarea>
          </div>
          <div class="text-end">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
      <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="mb-6">
              <label for="note" class="fw-medium text-heading mb-1">Enter Message:</label>
                <textarea wire:model='message'   class="form-control" rows="2" id="note">Remove this default message and Wite your message here, be aware it wil be sent via default system messaging </textarea>
            </div>
            <div class="text-end">
              <button type="button" class="btn btn-label-secondary me-3" data-bs-toggle="modal" data-bs-target="#twoFactorAuth"><span class="align-middle">Cancel</span></button>
