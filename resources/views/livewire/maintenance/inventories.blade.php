        ...
        <tr class="bg-gray-200 text-left">
            ...
            <th>Actions</th>
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <td>{{$count=DB::table('maint_inventories')->where('id', $inventory->id)->get()->value('name')}}</td>
            ...
            <div class="text-center mb-6">
              ...
              <div class="col-12">
                ...
                <div class="input-group input-group-merge">
                  <input wire:model='item_name' class="form-control form-control-lg" type="text" aria-describedby="modaladdFleet" placeholder="Generator" />
