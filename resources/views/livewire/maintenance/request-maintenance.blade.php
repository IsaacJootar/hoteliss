            ...
            <tbody>
                @foreach ($maintenances as $maintenance)
                    <tr wire:key='{{$maintenance->id}}'>
                        ...
                        <td>{{ $maintenance->assignedTechnician->full_name }}</td>
                        <td> {{$count=DB::table('maint_asset')->where('id', $asset->id)->get()->value('name')}}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addAsset" wire:click="edit({{ $maintenance->id }})">
    ...
    <div class="text-center mb-6">
      ...
      <div class="col-12">
        ...
        <div class="input-group input-group-merge">
          <input wire:model='title' class="form-control form-control-lg" type="text" aria-describedby="modaladdFleet" placeholder="Generator" />
