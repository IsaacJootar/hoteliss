        ...
        <tr class="bg-gray-200 text-left">
                ...
                <tbody>
                    @foreach($schedules as $schedule)
                            ...
                            <td>{{ $schedule->next_scheduled_date }}</td>
              ...
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text cursor-pointer p-1" id="modalAddCard2"><span class="card-type"></span></span>
                  ...
                  <select wire:model="asset_id" class="form-select form-select-lg" data-allow-clear="true">
                    ...
                    <div class="input-group input-group-merge">
                        <input wire:model="next_scheduled_date"   class="form-control form-control-lg" placeholder="Select arrival Date" type="text" id="flatpickr-date" required>
                        <span class="input-group-text cursor-pointer p-1" id="modalAddCard2"><span class="card-type"></span></span>
                    </div>
                    <br>
                    {{--
