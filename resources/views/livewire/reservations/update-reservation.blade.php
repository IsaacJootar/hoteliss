   ...
   <div class="row invoice-preview">
       ...
       <div class="card invoice-preview-card p-sm-12 p-6">
           ...
           <div class="alert alert-secondary alert-dismissible d-flex" role="alert">
               ...
               <div class="d-flex flex-column ps-1">
                 <h5 class="alert-heading mb-2">Reservation Form: Please Update Appropriately!</h5>
                 Arrival Date:
                 @php
               ...
               @endphp
                 ...
                 <p class="mb-0"><strong>Note:</strong> that all special requests are subject to availability and additional charges may apply.</p>
             ...
             <form onSubmit="return false">
               ...
               <div class="row">
                   ...
                   <div class="col-sm-6">
                       <label class="form-label" for="name-modern-vertical"><strong style="color: red">* </strong>Customer Name</label>
               ...
               <div class="row">
                   <div class="col-sm-6">
                       <label class="form-label" for="name-modern-vertical"><strong style="color: red">* </strong>Contact Number</label>
               ...
               <div class="row">
                   ...
                   <div class="col-sm-6">
                       <div class="form-group">
                           ...
                           <input wire:model="category_id" value="{{$category_id}}" style="visibility: hidden">
               ...
               <div class="col-sm-6">
                   <button wire:click='update' class="btn btn-secondary">Update Reservation </button>
                   <x-app-loader/>
               </div>
     ...
     <div class="col-xl-4 col-md-4 col-12 invoice-actions">
       <div class="card">
         <div class="card-body">
            ...
            <h6 class="card-title">
                ...
                Avai. Room (s) after this order</h6>
           <p class="card-text">
       ...
       @endforeach
           ...
           <h6 class="alert-heading mb-1"><x-page-label-secondary>  Reservation Policies</x-page-label-secondary></h6>
           <ul class="list-unstyled mb-0">

           <li> <span class="badge badge-dot bg-secondary me-1"></span> SecondaryUnpaid reservation must be confirmed 24 hours prior to arrival by making full payment </li>
           <li> <span class="badge badge-dot bg-secondary me-1"></span> Please note that all special requests are subject to availability and additional charges may apply</li>
           <li> <span class="badge badge-dot bg-secondary me-1"></span>All non-standard rates requires full pre-payment at the time of the booking and are non refundable nor transferable</li>

           <li> <span class="badge badge-dot bg-secondary me-1"></span>Confirmed reservations are non refundable nor transferable</li>
